...
latex_documents = [
    (master_doc, 'xomega.tex', 'xomega Documentation',
     'Takaya Uchida', 'manual'),
]
...
man_pages = [
    (master_doc, 'xomega', 'xomega Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xomega', 'xomega Documentation',
     author, 'xomega', 'One line description of project.',
     'Miscellaneous'),
]
